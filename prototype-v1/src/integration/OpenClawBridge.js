...
exports.OpenClawBridge = exports.OPENCLAW_CONFIG = void 0;
 ...
 */
class OpenClawBridge extends events_1.EventEmitter {
    constructor(options = {}) {
        super();
        ...
        this.baseUrl = options.baseUrl ?? exports.OPENCLAW_CONFIG.baseUrl;
        this.timeout = options.timeout ?? exports.OPENCLAW_CONFIG.timeout;
        this.maxRetries = options.maxRetries ?? exports.OPENCLAW_CONFIG.maxRetries;
        this.retryDelay = options.retryDelay ?? exports.OPENCLAW_CONFIG.retryDelay;
     ...
     * @param options 可选配置
     */
    async send(targetSession, message, options = {}) {
     ...
     * @param message 消息内容
     */
    async broadcast(sessions, message, options = {}) {
     ...
     * @param timeout 超时时间
     */
    async waitForResponse(correlationId, timeout) {
    ...
    // ==================== 内部方法 ====================
    async _doSend(targetSession, message, options) {
...
exports.OpenClawBridge = OpenClawBridge;
exports.default = OpenClawBridge;
