...
exports.TokenPool = exports.TOKEN_POOL_CONFIG = void 0;
const events_1 = require("events");
/** 契约版本号 */
const CONTRACT_VERSION = 1;
/** 令牌池配置（来自契约 TOKEN_POOL_CONFIG） */
exports.TOKEN_POOL_CONFIG = {
    maxSize: 10, // 最大令牌数
 ...
 * 令牌池类
 */
class TokenPool extends events_1.EventEmitter {
    constructor(options = {}) {
        super();
        this.availableTokens = [];
        this.waitingQueue = [];
        this.acquiredTokens = new Map();
        this.stats = {
            acquiredCount: 0,
            releasedCount: 0,
            timeoutCount: 0,
        ...
        this.maxSize = options.maxSize ?? exports.TOKEN_POOL_CONFIG.maxSize;
        this.acquireTimeout = options.acquireTimeout ?? exports.TOKEN_POOL_CONFIG.acquireTimeout;
        this.priorityLevels = options.priorityLevels ?? exports.TOKEN_POOL_CONFIG.priorityLevels;
        // 初始化令牌池
     ...
     */
    async acquire(priority = 'normal', agentId) {
    ...
    async _waitForToken(priority, priorityValue, agentId) {
...
exports.default = TokenPool;
//# sourceMappingURL=TokenPool.js.map